...
const arrowPath = "M6.36,7.79a1.43,1.43,0,0,1-1-.42L1.42,3.45a1.44,1.44,0,0,1,0-2c0.56-.56,9.31-0.56,9.87,0a1.44,1.44,0,0,1,0,2L7.37,7.37A1.43,1.43,0,0,1,6.36,7.79Z";
const arrowShadowPath = "M12.71,2.44A2.41,2.41,0,0,1,12,4.16L8.08,8.08a2.45,2.45,0,0,1-3.45,0L0.72,4.16A2.42,2.42,0,0,1,0,2.44,2.48,2.48,0,0,1,.71.71C1,0.47,1.43,0,6.36,0S11.75,0.46,12,.71A2.44,2.44,0,0,1,12.71,2.44Z";
...
/* harmony default export */ __webpack_exports__["default"] = (async function (_ref) {
  ...
  const iconPath = () => "/icons/".concat(useBlackIcons() ? "black_text" : "white_text");
  ...
  const apply = () => {
    const blockColors = JSON.parse(JSON.stringify(_lib_themes__WEBPACK_IMPORTED_MODULE_1__["defaultBlockColors"]));
    ...
    const newTheme = addon.tab.redux.state.scratchGui.theme.theme.set('blocks', _lib_themes__WEBPACK_IMPORTED_MODULE_1__["BLOCKS_CUSTOM"]);
  ...
  const disable = () => {
    const defaultTheme = Object(_lib_themes_themePersistance__WEBPACK_IMPORTED_MODULE_2__["detectTheme"])().blocks;
