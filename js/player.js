...
/******/ 	deferredModules.push(["./src/playground/player.jsx","vendors~addon-settings~credits~editor~embed~fullscreen~player","vendors~addon-settings~addons~editor~fullscreen~player","vendors~editor~embed~fullscreen~player","vendors~editor~fullscreen~player"]);
