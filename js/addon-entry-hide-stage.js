...
/* harmony default export */ __webpack_exports__["default"] = (async function (_ref) {
  ...
  function unhideStage(e) {
    ...
    if (e) {
      ...
      if (addon.tab.redux.state.scratchGui.stageSize.stageSize === "small") smallStageButton.setAttribute("aria-pressed", true);else largeStageButton.setAttribute("aria-pressed", true);
    }
    window.dispatchEvent(new Event("resize")); // resizes the code area and paint editor canvas
  }
